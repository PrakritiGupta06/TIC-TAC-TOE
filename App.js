...
export default class App extends React.Component {
  ...
  //Rrturns 1 if Player 1 won,-1 if Player 2 won,or a 0 if no one has won.
  getWinner=()=>{
    const NUM_TILES=3;
   ...
   return (
    ...
    <View style={styles.container}>
      ...
      <View style={{flexDirection:"row", alignItems:"center", justifyContent:"center"}}>
        ...
        <TouchableOpacity onPress={()=> this.onTilePress (1,2)} style ={[styles.tile,{ borderTopWidth:0, borderRightWidth:0 }]}>
        {this.renderIcon(1,2)}
        </TouchableOpacity>
      </View>
